export default function Multi(){
    ...
    return (
        ...
        <section>
        <div className="flex flex-col">
        <input className="rounded-2xl border-2 border-secondary-100 bg-secondary-500 placeholder:pl-4 mt-3 h-10" type="text" name="answer1" placeholder="Type in your answer"/>
